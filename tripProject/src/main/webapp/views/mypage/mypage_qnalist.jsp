        ...
        <div class="row">
          ...
          <aside class="col-lg-4 col-md-5 pe-xl-4 mb-5">
            ...
            <div class="card card-body border-0 shadow-sm pb-1 me-lg-1">
 				<div class="d-flex d-md-block d-lg-flex align-items-start pt-lg-2 mb-1">
					<c:if test="${!empty qnaM.profile}">
					 <label for="input-file"><img class="rounded-circle" src="upload/${qnaM.profile}" width="100"/></label>
					</c:if>
					<c:if test="${empty qnaM.profile}">
                ...
                <div class="pt-md-2 pt-lg-0 ps-3 ps-md-0 ps-lg-3">
                  <h2 class="fs-lg mb-0">${qnaM.id}</h2>
                  <ul class="list-unstyled fs-sm mt-3 mb-0">
                    <li><a class="nav-link fw-normal p-0" href="tel:3025550107"><i class="fi-phone opacity-60 me-2"></i>${qnaM.tel}</a></li>
                    <li><a class="nav-link fw-normal p-0" href="mailto:annette_black@email.com"><i class="fi-mail opacity-60 me-2"></i>${qnaM.mail}</a></li>
                  </ul>
                </div>
              </div>
              <div class="collapse d-md-block mt-3" id="account-nav">
                <div class="card-nav">
                  ...
                  <a class="card-nav-link" href="mypageLogout"><i class="fi-logout opacity-60 me-2"></i>로그아웃</a>
                </div>
              </div>
            </div>
          </aside>
          <div class="col-lg-8 col-md-7 mb-5">
            ...
            <!-- Tabs content-->
             ...
             <!-- 식당 QnA-->
             <c:forEach var="foodqna" items="${foodQnaList}">
              <div class="mb-4 pb-4 border-bottom">
                <div class="d-flex justify-content-between mb-3">
                  <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
                    <div class="ps-2">
                      <h6 class="fs-base mb-0">${foodqna.qna_title} </h6>
                  ...
                  <button class="btn btn-icon btn-light btn-xs rounded-circle shadow-sm" type="button" id="contextMenu1" data-bs-toggle="dropdown" aria-expanded="false"><i class="fi-dots-vertical"></i></button>
                      <ul class="dropdown-menu my-1" aria-labelledby="contextMenu1">
                        <li>
                         <form method="post" action="foodqnaModify" enctype="multipart/form-data">
                          <input type="hidden" name="id" value="${sessionScope.id} ">
                          <button class="dropdown-item" type="button"><i class="fi-edit opacity-60 me-2"></i>수정</button>
                         </form>
                        </li>
                        <li>
                         <form method="post" action="foodqnaDelete" enctype="multipart/form-data">
                          <input type="hidden" name="id" value="${sessionScope.id} ">
             ...
             <!-- 명소 QnA-->
             <c:forEach var="placeqna" items="${placeQnaList}">
              <div class="mb-4 pb-4 border-bottom">
                <div class="d-flex justify-content-between mb-3">
                  <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
                    <div class="ps-2">
                      <h6 class="fs-base mb-0">${placeqna.qna_title} </h6>
                  ...
                  <button class="btn btn-icon btn-light btn-xs rounded-circle shadow-sm" type="button" id="contextMenu1" data-bs-toggle="dropdown" aria-expanded="false"><i class="fi-dots-vertical"></i></button>
                      <ul class="dropdown-menu my-1" aria-labelledby="contextMenu1">
                        <li>
                         <form method="post" action="placeqnaModify" enctype="multipart/form-data">
                          <input type="hidden" name="id" value="${sessionScope.id} ">
                          <button class="dropdown-item" type="button"><i class="fi-edit opacity-60 me-2"></i>수정</button>
                         </form>
                        </li>
                        <li>
                         <form method="post" action="placeqnaDelete" enctype="multipart/form-data">
                          <input type="hidden" name="id" value="${sessionScope.id} ">
                          <button class="dropdown-item" type="button"><i class="fi-trash opacity-60 me-2"></i>삭제</button>
                         </form>
                        </li>
              ...
              <!-- 숙소 QnA-->
             <c:forEach var="roomqna" items="${roomQnaList}">
              <div class="d-flex justify-content-between mb-3">
                <div class="d-flex align-items-center pe-2"><img class="rounded-circle me-1" src="img/avatars/16.png" width="48" alt="Avatar">
                  <div class="ps-2">
                    <h6 class="fs-base mb-0">${roomqna.qna_title}</h6>
                ...
                <button class="btn btn-icon btn-light btn-xs rounded-circle shadow-sm" type="button" id="contextMenu1" data-bs-toggle="dropdown" aria-expanded="false"><i class="fi-dots-vertical"></i></button>
                      <ul class="dropdown-menu my-1" aria-labelledby="contextMenu1">
                        <li>
                         <form method="post" action="roomqnaModify" enctype="multipart/form-data">
                          <input type="hidden" name="id" value="${sessionScope.id} ">
                          <button class="dropdown-item" type="button"><i class="fi-edit opacity-60 me-2"></i>수정</button>
                         </form>
                        </li>
                        <li>
                        <form method="post" action="roomqnaDelete" enctype="multipart/form-data">
                          <input type="hidden" name="id" value="${sessionScope.id} ">
                          <button class="dropdown-item" type="button"><i class="fi-trash opacity-60 me-2"></i>삭제</button>
                         </form>
                        </li>
