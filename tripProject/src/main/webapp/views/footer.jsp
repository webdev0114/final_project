        ...
        <div class="row mb-5 pb-md-3 pb-lg-4">
          <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="d-flex flex-sm-row flex-column justify-content-between mx-n2">
              <div class="mb-sm-0 mb-4 px-2"><a class="navbar-brand me-3 me-xl-4" href="main"><i class="fi-map me-2">&ensp;My Seoul Trip</i></a>
                <br><br>
                <ul class="nav flex-column mb-sm-4 mb-2">
                  <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="mailto:myseoultrip@email.com"><i class="fi-mail mt-n1 me-2 align-middle opacity-70"></i>myseoultrip@email.com</a></li>
