...
<%--    <script src="./views/room/room_write.js"></script>--%>
          ...
          <div class="col-lg-8">
            ...
            <section class="card card-body border-0 shadow-sm p-4 mb-4" id="basic-info">
              ...
              <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" type="text" id="room_cost" name="room_cost" placeholder="가격을 입력하세요" required>
              </div>
            </section>
            ...
            <!-- Action buttons -->
           <!-- <section class="d-sm-flex justify-content-between pt-2"><a class="btn btn-outline-primary btn-lg d-block rounded-pill mb-3 mb-sm-2" href="#preview-modal" data-bs-toggle="modal"i class="fi-eye-on ms-n1 me-2><"></i>미리보기</a><a class="btn btn-primary btn-lg d-block rounded-pill mb-2" href="city-guide-business-promotion.html">저장하기</a></section> -->
          </div>
         </form>
