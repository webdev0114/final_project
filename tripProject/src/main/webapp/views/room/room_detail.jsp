      ...
      <section class="container mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="text-nowrap">
            <button class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle ms-2 mb-2" type="button" data-bs-toggle="tooltip" title="북마크추가"><i class="fi-bookmark"></i></button>
                ...
                <div class="card py-2 px-sm-4 px-3 shadow-sm">
                  <div class="card-body mx-n2">
                    ...
                    <div class="d-flex align-items-start mb-3 pb-0 border-bottom">
                      <div class="ps-2 ms-1">
                        <h3 class="h4 mb-2">${room.room_name } <i class="fi-star-filled mt-n1 me-1 text-warning align-middle opacity-70"></i><b>${room.room_star} </b></h3>
                        <ul class="list-unstyled d-flex flex-wrap fs-md row-cols-md-1">
                          ...
                          <li class="me-2 mb-2 pe-1"><i class="fi-map-pin mt-n1 me-1 align-middle opacity-70"></i>${room.room_addr }</li>
                          <li class="me-2 mb-2 pe-1"><i class="fi-phone mt-n1 me-1 align-middle opacity-70"></i>${room.room_tel }</li>
                          <li class="me-2 mb-2 pe-1"><i class="fi-credit-card mt-n1 me-1 align-middle opacity-70"></i>₩${room.room_cost }</li>
                          <li class="me-2 mb-2 pe-1"><i class="fi-clock mt-n1 me-1 align-middle opacity-70"></i>${room.room_option}</li>
                        </ul>
                      </div>
                    </div>
                    <!-- Place contacts-->
                    <div class="mb-0 pb-0">
                      ...
                      <ul class="list-unstyled d-flex flex-wrap row-cols-md-1">
                        <li class="me-2 mb-3 pe-1"><i class="fi-star-filled mt-n1 me-1 align-middle opacity-70"></i><b>${room.room_star }</b></li>
                        <p class="mb-3">${room.room_content }</p>
                        <li class="h6 col"><i class="fi-car mt-n1 me-1 align-middle opacity-70"></i>이동 안내</li>
                      </ul>
                    </div>
                  </div>
                </div>
